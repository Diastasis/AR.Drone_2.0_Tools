...
arTimeDev           = (ardroneLayers_1_2[7, 0], ardroneLayers_1_2[7, 1], ardroneLayers_3[7, 0]) # OK
...
arDataList = [arPkgTx, arPkgRx,arPkgLoss_num, arPkgLoss_perc, arTimeMin, arTimeAvg, arTimeMax, 
              arTimeDev, arPkgDouble_num, arPkgDouble_perc, arWifiReadings, arWifiQuality_num, 
...
#anafiPath_3 = '/home/ros/parrot2_ws/src/parrot_ardrone/Connection_quality/src/NPY/PC2DR_310320_150126_(full)_(ANAFI_FIXED).npy'
...
anTimeDev           = (anafiLayers[7, 0], anafiLayers[7, 1], anafiLayers[7, 2]) # OK
...
anDataList = [anPkgTx, anPkgRx,anPkgLoss_num, anPkgLoss_perc, anTimeMin, anTimeAvg, anTimeMax, 
              anTimeDev, anPkgDouble_num, anPkgDouble_perc, anWifiReadings, anWifiQuality_num, 
