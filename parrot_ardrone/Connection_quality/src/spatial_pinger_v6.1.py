...
# TODO
# ========================
# img_graphs() = create the the exclude functionality
...
ip_addr = "localhost"#"178.239.173.167"
count_ping = 5
count_wifi = 5
interpolation_type = interpolation='catrom'#"nearest" #"bicubic"
...
def save_dict2csv(data, headers):
    ...
    with open(file_path, mode='w') as csv_file:
        ...
        for key, value in temp2.items():
            value["x"],value["y"],value["z"] = key[0],key[1], key[2] # Add the points since till now they weren't included in dictionary
...
def save_npy(data):
    # save to npy file
    file_path = '/home/ros/parrot2_ws/src/parrot_ardrone/Connection_quality/src/NPY/ConQlt_{}.npy'.format(get_timestamp())
