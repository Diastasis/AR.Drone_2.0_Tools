...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  14 12:05:24 2020
@author: ros
...
newFile[0:14,0,:,:] = loadedData05_0[0:14,0,:,:]
newFile[14,0,:,:] = loadedData05_0[15,0,:,:]
newFile[15,0,:,:] = loadedData05_0[17,0,:,:]

newFile[0:14,1,:,:] = loadedData15_0[0:14,1,:,:]
newFile[14,1,:,:] = loadedData15_0[15,1,:,:]
newFile[15,1,:,:] = loadedData15_0[17,1,:,:]

newFile[0:14,2,:,:] = loadedData25_0[0:14,0,:,:]
newFile[14,2,:,:] = loadedData25_0[15,0,:,:]
newFile[15,2,:,:] = loadedData25_0[17,0,:,:]

newFile[0:14,3,:,:] = loadedData35_0[0:14,0,:,:]
newFile[14,3,:,:] = loadedData35_0[15,0,:,:]
newFile[15,3,:,:] = loadedData35_0[17,0,:,:]
