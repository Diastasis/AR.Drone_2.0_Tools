...
# 4) On Anafi, layer 1 and layer 2 are the same - this needs a fix
...
def oneVarVisual(title, arVar, anVar, difVar, outputName):
    ...
    #        imgplot.set_clim(60, 100)
            ...
            for i in range(11):
                for j in range(11):
                    ...
                    ax.text(j, i, arVar[ii][i][j], ha="center", va="center", color="w")
    ...
    #        imgplot.set_clim(60, 100)
            ...
            for i in range(11):
                for j in range(11):
                    ax.scatter(i,j, alpha=0.1, s=800, color="w") # cmap='jet'
                    ax.text(j, i, anVar[ii-4][i][j], ha="center", va="center", color="w")
    #                ax.text(j, i, anafiLayers[13,2,i, j], ha="center", va="center", color="w")
        else:
    ...
    #        imgplot.set_clim(60, 100)
            ...
            for i in range(11):
                for j in range(11):
                    ax.scatter(i,j, alpha=0.1, s=800, color="w") # cmap='jet'
                    ax.text(j, i, difVar[ii-6][i][j], ha="center", va="center", color="w")
    #                ax.text(j, i, anafiLayers[13,2,i, j], ha="center", va="center", color="w")
