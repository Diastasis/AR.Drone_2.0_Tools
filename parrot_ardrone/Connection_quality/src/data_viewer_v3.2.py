...
#    plt.subplots_adjust(left=0.0, right=1.0, bottom=0.0, top=1.0)
    ...
    if ii+1 < 4:
        ax.set_title("AR.Drone 2.0 ({}m)\n{}".format(layerDistance[ii], titles[12]))
...
#                ax.text(j, i, anafiLayers[13,2,i, j], ha="center", va="center", color="w")
        ...
        ax.set_title("Anafi ({}m)\n{}".format(layerDistance[ii-3], titles[12]))
...
#                ax.text(j, i, anafiLayers[13,2,i, j], ha="center", va="center", color="w")
        ...
        ax.set_title("Difference ({}m)\n{}".format(layerDistance[ii-6], titles[12]))
        imgplot = ax.imshow(difDataList[12][ii-6], cmap="jet",interpolation='gaussian') # interpolation='bicubic', origin='lower', interpolation='gaussian'
#        imgplot.set_clim(60, 100)
        fig.colorbar(imgplot, ax=ax,orientation='horizontal',shrink=0.76,pad=0.08)
        for i in range(11):
            for j in range(11):
...
#                ax.text(j, i, anafiLayers[13,2,i, j], ha="center", va="center", color="w")
fig.savefig("Link_Quality_percent.png", dpi=100)  # results in 160x120 px image
plt.show() 
#
#index = 3            
